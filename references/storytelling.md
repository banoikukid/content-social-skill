...
```
Quan sát dữ liệu (Ảnh / Brief)
            │
            ▼
Khám phá các góc nhìn tiềm năng (Possible Angles)
            │
            ▼
...
- **Khi chỉ có hình ảnh:** 
  - ✅ **Được phép:** Miêu tả thị giác (màu sắc, bọt, sương đá, ánh nắng) và tạo cảm xúc bằng ẩn dụ nghệ thuật:  
    *Ví dụ:* *"Nhìn lớp đá lấp lánh thôi cũng thấy mùa hè như dịu lại một nửa."*
  - ❌ **Không được phép:** Tự khẳng định cảm nhận vị giác/vật lý như sự thật khách quan:  
    *Tránh:* *"Uống vào thấy cổ họng mát lạnh, ngọt thanh tức thì"* (khi chưa có dữ kiện vị giác).
- **Khi có dữ kiện từ người dùng/menu:** Thoải mái miêu tả hương vị, độ đậm đà, mùi thơm theo đúng thông tin đã cho.
