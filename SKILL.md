...
3. Chỉ đọc tài liệu cần cho flow đang chạy:
   - `references/platforms.md` — format theo Facebook, TikTok/Reels, Zalo OA, Zalo Personal.
...
- Chi tiết cảm quan chỉ lấy từ brief/ảnh hoặc Safe Generic Vocabulary `[DEFAULT]`; gán nhãn FACT SOURCE cho mọi claim.
